              ...
              >
                ...
                <SwiperSlide>
                  <div className="ktestimonial mb-30 swiper-slide">
                    <div className="ktestimonial-text">
                      <p>
                        Reliable accessible UI components: :focus styles,
                        content sliders, dark mode, date pickers, navigation,
                        modals, radio buttons Neque porro est qui.
                      </p>
                    </div>
                    <div className="ktestimonial-author">
                      <div className="ktestimonial-author-img">
                  ...
                  <div className="ktestimonial mb-30 swiper-slide">
                    <div className="ktestimonial-text">
                      <p>
                        ...
                        CSS & JavaScript performance, assets optimizations,
                        build optimizations.
                      </p>
                    </div>
                    <div className="ktestimonial-author">
