...
const Contact = ({ padding }: ContactProps) => {
    ...
    axios
      .post(
        process.env.NEXT_PUBLIC_EMAILJS_URL,
        {
          ...emailSettings,
          template_params: {
            name: (form.elements.namedItem("name") as HTMLInputElement)?.value || defaultData.name,
            email: (form.elements.namedItem("email") as HTMLInputElement)?.value || defaultData.email,
            phone: (form.elements.namedItem("phone") as HTMLInputElement)?.value || defaultData.phone,
            subject: (form.elements.namedItem("subject") as HTMLInputElement)?.value || defaultData.subject,
            message: (form.elements.namedItem("message") as HTMLInputElement)?.value || defaultData.message,
          },
        },
        {
