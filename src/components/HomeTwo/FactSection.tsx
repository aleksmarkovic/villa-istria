          ...
          <div className="row gx-0">
            <div className="col-lg-3 col-sm-6">
              <div className="kfact text-center mb-30 wow fadeInUp" data-wow-duration=".3s">
                <div className="kfact-icon"><i><img src="assets/img/icon/fact-icon-1.png" className="img-fluid" alt="fact-icon-img" /></i></div>
            ...
            <div className="col-lg-3 col-sm-6">
              <div className="kfact text-center mb-30 wow fadeInUp" data-wow-duration=".6s">
                <div className="kfact-icon"><i><img src="assets/img/icon/fact-icon-2.png" className="img-fluid" alt="fact-icon-img" /></i></div>
            ...
            <div className="col-lg-3 col-sm-6">
              <div className="kfact text-center mb-30 wow fadeInUp" data-wow-duration=".9s">
                <div className="kfact-icon"><i><img src="assets/img/icon/fact-icon-3.png" className="img-fluid" alt="fact-icon-img" /></i></div>
            ...
            <div className="col-lg-3 col-sm-6">
              <div className="kfact kfact-last-child text-center mb-30 wow fadeInUp" data-wow-duration="1s">
                <div className="kfact-icon"><i><img src="assets/img/icon/fact-icon-4.png" className="img-fluid" alt="fact-icon-img" /></i></div>
