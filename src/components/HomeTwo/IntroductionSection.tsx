                ...
                <div className="kintro-text ml-70" data-aos="fade-left" data-aos-duration="1000">
                  ...
                  <div className="skill--content">
                    <div className="skill__wrapper mb-20">
                      ...
                      <div className="progress"><div className="progress-bar bg-theme wow slideInLeft"></div></div>
                    </div>
                    <div className="skill__wrapper mb-60">
                      ...
                      <div className="progress progress-two"><div className="progress-bar bg-theme wow slideInLeft"></div></div>
                    </div>
                  </div>
